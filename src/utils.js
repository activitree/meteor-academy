...
export function getTimeDifference (date) {
  ...
  else if (difference < 86400 * 30) { return `${Math.floor(difference / 86400)} days` } else if (difference < 86400 * 30 * 12) { return `${Math.floor(difference / 86400 / 30)} months` } else return `${(difference / 86400 / 30 / 12).toFixed(1)} years`
}
